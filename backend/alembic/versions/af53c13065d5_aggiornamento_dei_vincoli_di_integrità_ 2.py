"""Aggiornamento dei vincoli di integrità referenziale

Revision ID: af53c13065d5
Revises: 67d288c984e4
Create Date: 2024-10-24 00:42:50.452299
...
revision: str = 'af53c13065d5'
down_revision: Union[str, None] = '67d288c984e4'
...
def upgrade() -> None:
    ...
    op.create_foreign_key(None, 'area_conquests', 'zones', ['zone_id'], ['id'], onupdate='CASCADE')
    ...
    op.create_foreign_key(None, 'fiends', 'species_conquests', ['species_conquest_id'], ['id'], onupdate='CASCADE')
    op.create_foreign_key(None, 'fiends', 'zones', ['zone_id'], ['id'], onupdate='CASCADE')
